...
FROM (VALUES
    ('2026-04-01'::date, 'Melaminas del Perú S.A.C.', 'Melamina Blanco 18mm',   10,   152.00, 'F001-005', 'Compra inicio mes'),
    ('2026-04-02'::date, 'Ferretodo S.A.C.',          'Mapresa (fondo)',          6,   100.00, 'F002-009', 'Stock inicio abril'),
    ('2026-04-03'::date, 'Ferretodo S.A.C.',          'Tornillos (caja 1000)',    2,    82.00, 'F002-010', 'Reposición tornillos'),
    ('2026-04-05'::date, 'Melaminas del Perú S.A.C.', 'Melamina Color 18mm',     5,   182.00, 'F001-006', 'Para cómodas abril'),
    ('2026-04-07'::date, 'Maderas Noble E.I.R.L.',    'Tapacanto (rollo)',        4,    36.00, 'F003-004', 'Varios colores'),
    ('2026-04-08'::date, 'Ferretodo S.A.C.',          'Jaladores',             200,     1.00, 'F002-011', 'Surtido modelos'),
    ('2026-04-10'::date, 'Maderas Noble E.I.R.L.',    'Correderas (30cm)',       40,    20.00, 'F003-005', 'Stock correderas'),
    ('2026-04-12'::date, 'Ferretodo S.A.C.',          'Bisagras (caja 100)',      1,    92.00, 'F002-012', 'Reposición bisagras'),
    ('2026-04-14'::date, 'Acabados y Más S.A.C.',     'Laca selladora',           8,    28.00, 'F004-003', 'Para acabados'),
    ('2026-04-15'::date, 'Acabados y Más S.A.C.',     'Pegamento contacto',      12,    12.50, 'F004-004', 'Pegamento contacto'),
    ('2026-04-16'::date, 'Ferretodo S.A.C.',          'Patitas',               250,     0.40, 'F002-013', 'Surtido tamaños'),
    ('2026-04-18'::date, 'Melaminas del Perú S.A.C.', 'Melamina Blanco 18mm',    8,   155.00, 'F001-007', 'Reposición urgente'),
    ('2026-04-22'::date, 'Ferretodo S.A.C.',          'Mapresa (fondo)',          5,   102.00, 'F002-014', 'Reposición fondo'),
    ('2026-04-24'::date, 'Melaminas del Perú S.A.C.', 'Melamina Color 18mm',     4,   182.00, 'F001-008', 'Reposición color'),
    ('2026-04-25'::date, 'Ferretodo S.A.C.',          'Tornillos (caja 1000)',    1,    82.00, 'F002-015', 'Reposición'),
    ('2026-04-28'::date, 'Maderas Noble E.I.R.L.',    'Tapacanto (rollo)',        3,    36.00, 'F003-006', 'Reposición cierre mes'),
    ('2026-04-29'::date, 'Ferretodo S.A.C.',          'Jaladores',             100,     1.00, 'F002-016', 'Reposición jaladores')
...
VALUES
    ('OP-2026-008','2026-04-01','2026-04-05','2026-04-04',
    ...
    ('OP-2026-009','2026-04-03','2026-04-08','2026-04-07',
    ...
    ('OP-2026-010','2026-04-08','2026-04-12','2026-04-11',
    ...
    ('OP-2026-011','2026-04-10','2026-04-15','2026-04-14',
    ...
    ('OP-2026-012','2026-04-15','2026-04-20','2026-04-19',
    ...
    ('OP-2026-015','2026-04-28','2026-05-03',NULL,
...
FROM (VALUES
    ('OP-2026-008','2026-04-04'::date,'Ropero',  10, 3600.00,1050.00,'Stock + pedidos','Lote 1 abril'),
    ('OP-2026-009','2026-04-07'::date,'Velador', 30, 1350.00, 750.00,'Retail',         'Alta rotación'),
    ('OP-2026-010','2026-04-11'::date,'Ropero',  12, 4320.00,1260.00,'Mayoristas',     'Pedido mayoristas'),
    ('OP-2026-011','2026-04-14'::date,'Velador', 25, 1125.00, 625.00,'Retail',         'Reposición'),
    ('OP-2026-012','2026-04-19'::date,'Cómoda',  10, 1800.00, 600.00,'Stock',          'Reposición cómodas'),
    ('OP-2026-013','2026-04-24'::date,'Ropero',  12, 4320.00,1260.00,'Pedidos finales','Cierre mes'),
    ('OP-2026-014','2026-04-29'::date,'Estante', 10, 1200.00, 500.00,'Stock',          'Reposición estantes')
...
JOIN material m ON m.nombre = cons.material_nombre
WHERE op.numero_orden = 'OP-2026-008';

-- Consumo: OP-2026-009 → Velador ×30
INSERT INTO consumo_material (produccion_id, material_id, cantidad_consumida, costo_unitario)
SELECT p.id, m.id, cons.cantidad, cons.precio
FROM produccion p
JOIN orden_produccion op ON op.id = p.orden_produccion_id
...
JOIN material m ON m.nombre = cons.material_nombre
WHERE op.numero_orden = 'OP-2026-009';

-- Consumo: OP-2026-010 → Ropero ×12
INSERT INTO consumo_material (produccion_id, material_id, cantidad_consumida, costo_unitario)
SELECT p.id, m.id, cons.cantidad, cons.precio
FROM produccion p
JOIN orden_produccion op ON op.id = p.orden_produccion_id
...
JOIN material m ON m.nombre = cons.material_nombre
WHERE op.numero_orden = 'OP-2026-010';

-- Consumo: OP-2026-011 → Velador ×25
INSERT INTO consumo_material (produccion_id, material_id, cantidad_consumida, costo_unitario)
SELECT p.id, m.id, cons.cantidad, cons.precio
FROM produccion p
JOIN orden_produccion op ON op.id = p.orden_produccion_id
...
JOIN material m ON m.nombre = cons.material_nombre
WHERE op.numero_orden = 'OP-2026-011';

-- Consumo: OP-2026-012 → Cómoda ×10
INSERT INTO consumo_material (produccion_id, material_id, cantidad_consumida, costo_unitario)
SELECT p.id, m.id, cons.cantidad, cons.precio
FROM produccion p
JOIN orden_produccion op ON op.id = p.orden_produccion_id
...
JOIN material m ON m.nombre = cons.material_nombre
WHERE op.numero_orden = 'OP-2026-012';

-- Consumo: OP-2026-013 → Ropero ×12
INSERT INTO consumo_material (produccion_id, material_id, cantidad_consumida, costo_unitario)
SELECT p.id, m.id, cons.cantidad, cons.precio
FROM produccion p
JOIN orden_produccion op ON op.id = p.orden_produccion_id
...
JOIN material m ON m.nombre = cons.material_nombre
WHERE op.numero_orden = 'OP-2026-013';

-- Consumo: OP-2026-014 → Estante ×10
INSERT INTO consumo_material (produccion_id, material_id, cantidad_consumida, costo_unitario)
SELECT p.id, m.id, cons.cantidad, cons.precio
FROM produccion p
JOIN orden_produccion op ON op.id = p.orden_produccion_id
...
JOIN material m ON m.nombre = cons.material_nombre
WHERE op.numero_orden = 'OP-2026-014';
...
VALUES ('2026-04-01',(SELECT id FROM cliente WHERE documento='34567890'),
...
WITH v AS (INSERT INTO venta (fecha,cliente_id,tipo_venta_id,usuario_id)
VALUES ('2026-04-02',(SELECT id FROM cliente WHERE documento='56789012'),
        (SELECT id FROM tipo_venta WHERE nombre='Contado'),
...
WITH v AS (INSERT INTO venta (fecha,cliente_id,tipo_venta_id,usuario_id)
VALUES ('2026-04-03',(SELECT id FROM cliente WHERE documento='67890123'),
        (SELECT id FROM tipo_venta WHERE nombre='Contado'),
        (SELECT id FROM usuario WHERE email='juan@muebleria.com')) RETURNING id)
INSERT INTO detalle_venta (venta_id,producto_id,cantidad,precio_unitario)
SELECT v.id,p.id,d.c,d.pr FROM v,
...
WITH v AS (INSERT INTO venta (fecha,cliente_id,tipo_venta_id,usuario_id)
VALUES ('2026-04-04',(SELECT id FROM cliente WHERE documento='78901234'),
        (SELECT id FROM tipo_venta WHERE nombre='Contado'),
        (SELECT id FROM usuario WHERE email='luis@muebleria.com')) RETURNING id)
INSERT INTO detalle_venta (venta_id,producto_id,cantidad,precio_unitario)
SELECT v.id,p.id,d.c,d.pr FROM v,
...
WITH v AS (INSERT INTO venta (fecha,cliente_id,tipo_venta_id,usuario_id)
VALUES ('2026-04-06',(SELECT id FROM cliente WHERE documento='89012345'),
        (SELECT id FROM tipo_venta WHERE nombre='Contado'),
        (SELECT id FROM usuario WHERE email='juan@muebleria.com')) RETURNING id)
INSERT INTO detalle_venta (venta_id,producto_id,cantidad,precio_unitario)
SELECT v.id,p.id,d.c,d.pr FROM v,
...
WITH v AS (INSERT INTO venta (fecha,cliente_id,tipo_venta_id,usuario_id)
VALUES ('2026-04-06',(SELECT id FROM cliente WHERE documento='90123456'),
        (SELECT id FROM tipo_venta WHERE nombre='Contado'),
        (SELECT id FROM usuario WHERE email='luis@muebleria.com')) RETURNING id)
INSERT INTO detalle_venta (venta_id,producto_id,cantidad,precio_unitario)
...
WITH v AS (INSERT INTO venta (fecha,cliente_id,tipo_venta_id,usuario_id)
VALUES ('2026-04-08',(SELECT id FROM cliente WHERE documento='20111222333'),
...
WITH v AS (INSERT INTO venta (fecha,cliente_id,tipo_venta_id,usuario_id)
VALUES ('2026-04-09',(SELECT id FROM cliente WHERE documento='11223344'),
        (SELECT id FROM tipo_venta WHERE nombre='Contado'),
        (SELECT id FROM usuario WHERE email='juan@muebleria.com')) RETURNING id)
INSERT INTO detalle_venta (venta_id,producto_id,cantidad,precio_unitario)
SELECT v.id,p.id,d.c,d.pr FROM v,
...
WITH v AS (INSERT INTO venta (fecha,cliente_id,tipo_venta_id,usuario_id)
VALUES ('2026-04-10',(SELECT id FROM cliente WHERE documento='01234567'),
        (SELECT id FROM tipo_venta WHERE nombre='Contado'),
        (SELECT id FROM usuario WHERE email='luis@muebleria.com')) RETURNING id)
INSERT INTO detalle_venta (venta_id,producto_id,cantidad,precio_unitario)
SELECT v.id,p.id,d.c,d.pr FROM v,
...
WITH v AS (INSERT INTO venta (fecha,cliente_id,tipo_venta_id,usuario_id)
VALUES ('2026-04-11',(SELECT id FROM cliente WHERE documento='22334455'),
        (SELECT id FROM tipo_venta WHERE nombre='Contado'),
        (SELECT id FROM usuario WHERE email='juan@muebleria.com')) RETURNING id)
INSERT INTO detalle_venta (venta_id,producto_id,cantidad,precio_unitario)
...
WITH v AS (INSERT INTO venta (fecha,cliente_id,tipo_venta_id,usuario_id)
VALUES ('2026-04-13',(SELECT id FROM cliente WHERE documento='87654321'),
        (SELECT id FROM tipo_venta WHERE nombre='Contado'),
        (SELECT id FROM usuario WHERE email='luis@muebleria.com')) RETURNING id)
INSERT INTO detalle_venta (venta_id,producto_id,cantidad,precio_unitario)
SELECT v.id,p.id,d.c,d.pr FROM v,
...
WITH v AS (INSERT INTO venta (fecha,cliente_id,tipo_venta_id,usuario_id)
VALUES ('2026-04-13',(SELECT id FROM cliente WHERE documento='33445566'),
        (SELECT id FROM tipo_venta WHERE nombre='Contado'),
        (SELECT id FROM usuario WHERE email='juan@muebleria.com')) RETURNING id)
INSERT INTO detalle_venta (venta_id,producto_id,cantidad,precio_unitario)
SELECT v.id,p.id,d.c,d.pr FROM v,
...
WITH v AS (INSERT INTO venta (fecha,cliente_id,tipo_venta_id,usuario_id)
VALUES ('2026-04-15',(SELECT id FROM cliente WHERE documento='44556677'),
        (SELECT id FROM tipo_venta WHERE nombre='Contado'),
        (SELECT id FROM usuario WHERE email='luis@muebleria.com')) RETURNING id)
INSERT INTO detalle_venta (venta_id,producto_id,cantidad,precio_unitario)
SELECT v.id,p.id,d.c,d.pr FROM v,
...
WITH v AS (INSERT INTO venta (fecha,cliente_id,tipo_venta_id,usuario_id)
VALUES ('2026-04-16',(SELECT id FROM cliente WHERE documento='55667788'),
        (SELECT id FROM tipo_venta WHERE nombre='Contado'),
        (SELECT id FROM usuario WHERE email='juan@muebleria.com')) RETURNING id)
INSERT INTO detalle_venta (venta_id,producto_id,cantidad,precio_unitario)
SELECT v.id,p.id,d.c,d.pr FROM v,
...
WITH v AS (INSERT INTO venta (fecha,cliente_id,tipo_venta_id,usuario_id)
VALUES ('2026-04-17',(SELECT id FROM cliente WHERE documento='66778899'),
        (SELECT id FROM tipo_venta WHERE nombre='Contado'),
        (SELECT id FROM usuario WHERE email='luis@muebleria.com')) RETURNING id)
INSERT INTO detalle_venta (venta_id,producto_id,cantidad,precio_unitario)
SELECT v.id,p.id,d.c,d.pr FROM v,
...
WITH v AS (INSERT INTO venta (fecha,cliente_id,tipo_venta_id,usuario_id)
VALUES ('2026-04-18',(SELECT id FROM cliente WHERE documento='20444555666'),
        (SELECT id FROM tipo_venta WHERE nombre='Crédito'),
        (SELECT id FROM usuario WHERE email='juan@muebleria.com')) RETURNING id)
INSERT INTO detalle_venta (venta_id,producto_id,cantidad,precio_unitario)
SELECT v.id,p.id,d.c,d.pr FROM v,
...
WITH v AS (INSERT INTO venta (fecha,cliente_id,tipo_venta_id,usuario_id)
VALUES ('2026-04-20',(SELECT id FROM cliente WHERE documento='77889900'),
        (SELECT id FROM tipo_venta WHERE nombre='Contado'),
        (SELECT id FROM usuario WHERE email='juan@muebleria.com')) RETURNING id)
INSERT INTO detalle_venta (venta_id,producto_id,cantidad,precio_unitario)
SELECT v.id,p.id,d.c,d.pr FROM v,
...
WITH v AS (INSERT INTO venta (fecha,cliente_id,tipo_venta_id,usuario_id)
VALUES ('2026-04-21',(SELECT id FROM cliente WHERE documento='88990011'),
        (SELECT id FROM tipo_venta WHERE nombre='Contado'),
        (SELECT id FROM usuario WHERE email='luis@muebleria.com')) RETURNING id)
INSERT INTO detalle_venta (venta_id,producto_id,cantidad,precio_unitario)
SELECT v.id,p.id,d.c,d.pr FROM v,
...
WITH v AS (INSERT INTO venta (fecha,cliente_id,tipo_venta_id,usuario_id)
VALUES ('2026-04-22',(SELECT id FROM cliente WHERE documento='99001122'),
        (SELECT id FROM tipo_venta WHERE nombre='Contado'),
        (SELECT id FROM usuario WHERE email='juan@muebleria.com')) RETURNING id)
INSERT INTO detalle_venta (venta_id,producto_id,cantidad,precio_unitario)
SELECT v.id,p.id,d.c,d.pr FROM v,
...
WITH v AS (INSERT INTO venta (fecha,cliente_id,tipo_venta_id,usuario_id)
VALUES ('2026-04-24',(SELECT id FROM cliente WHERE documento='12345678'),
        (SELECT id FROM tipo_venta WHERE nombre='Contado'),
        (SELECT id FROM usuario WHERE email='juan@muebleria.com')) RETURNING id)
INSERT INTO detalle_venta (venta_id,producto_id,cantidad,precio_unitario)
SELECT v.id,p.id,d.c,d.pr FROM v,
...
WITH v AS (INSERT INTO venta (fecha,cliente_id,tipo_venta_id,usuario_id)
VALUES ('2026-04-25',(SELECT id FROM cliente WHERE documento='10203040'),
        (SELECT id FROM tipo_venta WHERE nombre='Contado'),
        (SELECT id FROM usuario WHERE email='luis@muebleria.com')) RETURNING id)
INSERT INTO detalle_venta (venta_id,producto_id,cantidad,precio_unitario)
SELECT v.id,p.id,d.c,d.pr FROM v,
...
WITH v AS (INSERT INTO venta (fecha,cliente_id,tipo_venta_id,usuario_id)
VALUES ('2026-04-27',(SELECT id FROM cliente WHERE documento='20304050'),
        (SELECT id FROM tipo_venta WHERE nombre='Contado'),
        (SELECT id FROM usuario WHERE email='juan@muebleria.com')) RETURNING id)
INSERT INTO detalle_venta (venta_id,producto_id,cantidad,precio_unitario)
SELECT v.id,p.id,d.c,d.pr FROM v,
...
WITH v AS (INSERT INTO venta (fecha,cliente_id,tipo_venta_id,usuario_id)
VALUES ('2026-04-28',(SELECT id FROM cliente WHERE documento='30405060'),
        (SELECT id FROM tipo_venta WHERE nombre='Contado'),
        (SELECT id FROM usuario WHERE email='luis@muebleria.com')) RETURNING id)
INSERT INTO detalle_venta (venta_id,producto_id,cantidad,precio_unitario)
SELECT v.id,p.id,d.c,d.pr FROM v,
...
WITH v AS (INSERT INTO venta (fecha,cliente_id,tipo_venta_id,usuario_id)
VALUES ('2026-04-29',(SELECT id FROM cliente WHERE documento='40506070'),
        (SELECT id FROM tipo_venta WHERE nombre='Contado'),
        (SELECT id FROM usuario WHERE email='juan@muebleria.com')) RETURNING id)
INSERT INTO detalle_venta (venta_id,producto_id,cantidad,precio_unitario)
SELECT v.id,p.id,d.c,d.pr FROM v,
...
WITH v AS (INSERT INTO venta (fecha,cliente_id,tipo_venta_id,usuario_id)
VALUES ('2026-04-30',(SELECT id FROM cliente WHERE documento='20777888999'),
        (SELECT id FROM tipo_venta WHERE nombre='Contado'),
        (SELECT id FROM usuario WHERE email='juan@muebleria.com')) RETURNING id)
INSERT INTO detalle_venta (venta_id,producto_id,cantidad,precio_unitario)
SELECT v.id,p.id,d.c,d.pr FROM v,
...
WITH v AS (INSERT INTO venta (fecha,cliente_id,tipo_venta_id,usuario_id)
VALUES ('2026-04-30',(SELECT id FROM cliente WHERE documento='50607080'),
        (SELECT id FROM tipo_venta WHERE nombre='Contado'),
        (SELECT id FROM usuario WHERE email='luis@muebleria.com')) RETURNING id)
INSERT INTO detalle_venta (venta_id,producto_id,cantidad,precio_unitario)
SELECT v.id,p.id,d.c,d.pr FROM v,
...
-- ============================================================
--  7. CUENTAS POR COBRAR — ventas a crédito abril (30 días plazo)
-- ============================================================
...
WHERE v.tipo_venta_id = (SELECT id FROM tipo_venta WHERE nombre='Crédito')
  AND v.fecha BETWEEN '2026-04-01' AND '2026-04-30'
...
SELECT cc.id,'2026-04-10',2150.00,'transferencia','TRF-BN-20260410',
...
INSERT INTO pago_cliente (cuenta_cobrar_id, fecha, monto, metodo_pago, referencia, usuario_id)
SELECT cc.id,'2026-04-15',2220.00,'transferencia','TRF-BCP-20260415',
       (SELECT id FROM usuario WHERE email='maria@muebleria.com')
FROM cuentas_cobrar cc
JOIN venta v ON v.id = cc.venta_id
JOIN cliente c ON c.id = v.cliente_id
...
INSERT INTO pago_cliente (cuenta_cobrar_id, fecha, monto, metodo_pago, referencia, usuario_id)
SELECT cc.id,'2026-04-20',2000.00,'transferencia','TRF-IBK-20260420',
       (SELECT id FROM usuario WHERE email='maria@muebleria.com')
FROM cuentas_cobrar cc
JOIN venta v ON v.id = cc.venta_id
JOIN cliente c ON c.id = v.cliente_id
...
SELECT g.fecha, cg.id, g.monto, g.detalle, g.comprobante,
       (SELECT id FROM usuario WHERE email='maria@muebleria.com')
FROM (VALUES
    ('2026-04-01'::date, 'Alquiler local + servicios',        2800.00, 'Alquiler taller + agua + luz abril',        'REC-007'),
    ('2026-04-01'::date, 'Servicios (luz, agua, internet)',    320.00,  'Internet taller abril',                     'REC-008'),
    ('2026-04-10'::date, 'Compra Melamina y accesorios',      4500.00, 'Compra materiales primera quincena',        'F-VARS-03'),
    ('2026-04-15'::date, 'Mano de Obra (eventual)',           7200.00, 'Pago 3 operarios + maestro (quincena)',     'PL-003'),
    ('2026-04-18'::date, 'Compra Melamina y accesorios',      4300.00, 'Compra materiales segunda quincena',        'F-VARS-04'),
    ('2026-04-20'::date, 'Transporte y delivery',             1100.00, 'Entregas a clientes y recojo materiales',   'REC-009'),
    ('2026-04-25'::date, 'Otros (herramientas, etc.)',         580.00, 'Mantenimiento maquinaria y herramientas',   'REC-010'),
    ('2026-04-28'::date, 'Marketing y publicidad',             420.00, 'Publicidad Facebook, Instagram y volantes', 'REC-011'),
    ('2026-04-30'::date, 'Mano de Obra (eventual)',           7200.00, 'Pago 3 operarios + maestro (fin de mes)',   'PL-004'),
    ('2026-04-30'::date, 'Servicios (luz, agua, internet)',    300.00, 'Luz y agua - cierre mes',                   'REC-012')
...
SELECT
    (SELECT id FROM caja WHERE fecha_apertura='2026-04-01' LIMIT 1),
    mc.fecha, mc.tipo, mc.concepto, mc.monto, mc.metodo_pago, mc.ref_tabla,
    (SELECT id FROM usuario WHERE email='maria@muebleria.com')
FROM (VALUES
    -- INGRESOS — ventas contado (cada cliente compra 1 sola vez)
    ('2026-04-01'::timestamptz,'ingreso','Venta contado - María Huanca (Cómoda ×2 + Velador ×3)',            1230.00,'efectivo',    'venta'),
    ('2026-04-02'::timestamptz,'ingreso','Venta contado - José Flores (Velador ×5 + Tocador ×1)',            1100.00,'efectivo',    'venta'),
    ('2026-04-03'::timestamptz,'ingreso','Venta contado - Pedro Ticona (Ropero ×1 + Velador ×2)',             940.00,'efectivo',    'venta'),
    ('2026-04-04'::timestamptz,'ingreso','Venta contado - Carmen Apaza (Cómoda ×1 + Comodín ×2)',             940.00,'efectivo',    'venta'),
    ('2026-04-06'::timestamptz,'ingreso','Venta contado - Jorge Ccama (Ropero ×2 + Velador ×4)',             1880.00,'efectivo',    'venta'),
    ('2026-04-06'::timestamptz,'ingreso','Venta contado - Luisa Choque (Tocador ×1)',                         650.00,'efectivo',    'venta'),
    ('2026-04-09'::timestamptz,'ingreso','Venta contado - Sonia Mamani C. (Cómoda ×2 + Velador ×4)',         1320.00,'efectivo',    'venta'),
    ('2026-04-10'::timestamptz,'ingreso','Venta contado - Roberto Pari (Ropero ×2 + Velador ×3)',            1790.00,'efectivo',    'venta'),
    ('2026-04-11'::timestamptz,'ingreso','Venta contado - Diego Quispe R. (Ropero ×2)',                      1520.00,'efectivo',    'venta'),
    ('2026-04-13'::timestamptz,'ingreso','Venta contado - Carlos Mamani (Tocador ×1 + Velador ×3)',           920.00,'efectivo',    'venta'),
    ('2026-04-13'::timestamptz,'ingreso','Venta contado - Francisca Cano (Comodín ×2 + Estante ×1)',          740.00,'efectivo',    'venta'),
    ('2026-04-15'::timestamptz,'ingreso','Venta contado - Alberto Ramos (Ropero ×2 + Cómoda ×1)',            2000.00,'efectivo',    'venta'),
    ('2026-04-16'::timestamptz,'ingreso','Venta contado - Teresa Vilca (Velador ×6 + Cómoda ×2)',            1500.00,'efectivo',    'venta'),
    ('2026-04-17'::timestamptz,'ingreso','Venta contado - Miguel Sucari (Ropero ×2 + Cómoda ×2)',            2480.00,'efectivo',    'venta'),
    ('2026-04-20'::timestamptz,'ingreso','Venta contado - Patricia Luna (Velador ×6 + Comodín ×3)',          1230.00,'efectivo',    'venta'),
    ('2026-04-21'::timestamptz,'ingreso','Venta contado - Raúl Coila (Ropero ×2 + Estante ×2)',             2080.00,'efectivo',    'venta'),
    ('2026-04-22'::timestamptz,'ingreso','Venta contado - Elena Machaca (Tocador ×2 + Velador ×4)',          1660.00,'efectivo',    'venta'),
    ('2026-04-24'::timestamptz,'ingreso','Venta contado - Ana Torres (Ropero ×1 + Cómoda ×2)',               1720.00,'efectivo',    'venta'),
    ('2026-04-25'::timestamptz,'ingreso','Venta contado - Fernando Turpo (Velador ×5 + Ropero ×2)',          1970.00,'efectivo',    'venta'),
    ('2026-04-27'::timestamptz,'ingreso','Venta contado - Gloria Condori M. (Ropero ×2 + Comodín ×3)',      2210.00,'efectivo',    'venta'),
    ('2026-04-28'::timestamptz,'ingreso','Venta contado - Andrés Cuti (Tocador ×1 + Velador ×5)',            1100.00,'efectivo',    'venta'),
    ('2026-04-29'::timestamptz,'ingreso','Venta contado - Beatriz Sulla (Cómoda ×2 + Estante ×2 + Velador ×3)', 1790.00,'efectivo','venta'),
    ('2026-04-30'::timestamptz,'ingreso','Venta contado - Mueblería Centro (Ropero ×3 + Cómoda ×3 + Estante ×1)', 3800.00,'transferencia','venta'),
    ('2026-04-30'::timestamptz,'ingreso','Venta contado - Víctor Alanoca (Velador ×4 + Ropero ×1)',          1120.00,'efectivo',    'venta'),
    -- INGRESOS — cobros de créditos marzo
    ('2026-04-10'::timestamptz,'ingreso','Pago crédito - Muebles El Norte (saldo marzo)',                    2150.00,'transferencia','pago_cliente'),
    ('2026-04-15'::timestamptz,'ingreso','Pago crédito - Distribuidora Altiplano (saldo marzo)',             2220.00,'transferencia','pago_cliente'),
    ('2026-04-20'::timestamptz,'ingreso','Pago crédito - Mueblería Centro (abono parcial marzo)',            2000.00,'transferencia','pago_cliente'),
    -- EGRESOS
    ('2026-04-01'::timestamptz,'egreso', 'Alquiler local + servicios - abril',                               2800.00,'efectivo',    'gasto'),
    ('2026-04-01'::timestamptz,'egreso', 'Internet taller - abril',                                           320.00,'transferencia','gasto'),
    ('2026-04-10'::timestamptz,'egreso', 'Compra materiales primera quincena',                               4500.00,'efectivo',    'gasto'),
    ('2026-04-15'::timestamptz,'egreso', 'Pago planilla operarios - quincena',                               7200.00,'efectivo',    'gasto'),
    ('2026-04-18'::timestamptz,'egreso', 'Compra materiales segunda quincena',                               4300.00,'efectivo',    'gasto'),
    ('2026-04-20'::timestamptz,'egreso', 'Transporte y delivery abril',                                      1100.00,'efectivo',    'gasto'),
    ('2026-04-25'::timestamptz,'egreso', 'Mantenimiento herramientas y maquinaria',                           580.00,'efectivo',    'gasto'),
    ('2026-04-28'::timestamptz,'egreso', 'Publicidad redes sociales y volantes',                               420.00,'transferencia','gasto'),
    ('2026-04-30'::timestamptz,'egreso', 'Pago planilla operarios - fin de mes',                             7200.00,'efectivo',    'gasto'),
    ('2026-04-30'::timestamptz,'egreso', 'Luz y agua - cierre mes',                                           300.00,'efectivo',    'gasto')
) AS mc(fecha, tipo, concepto, monto, metodo_pago, ref_tabla);

-- Cierre de caja al 30 de abril
UPDATE caja
SET fecha_cierre      = '2026-04-30',
    estado            = 'cerrada',
...
WHERE fecha_apertura  = '2026-04-01' AND estado = 'abierta';
...
SELECT fecha_apertura, fecha_cierre, saldo_inicial,
       ...
       saldo_final, estado
FROM caja
WHERE fecha_apertura = '2026-04-01';
